...
export type CloseInput<
  ...
  TAccountStakingfrontend extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountStakingfrontend>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountStakingfrontend> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.stakingfrontend),
    ],
    programAddress,
...
> = {
  ...
  accounts: {
    ...
    stakingfrontend: TAccountMetas[1];
  };
